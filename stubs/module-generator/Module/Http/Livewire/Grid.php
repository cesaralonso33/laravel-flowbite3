...
use Modules\{Module}\Models\{Model}Column as columncrad;
...
final class Grid extends PowerGridComponent
{
    ...
    */
     ...
     *
     * @return Builder<\App\Models\{Model}>
     */
    public function datasource(): Builder
    {

        //  dd({Model}::query()->with('tempfile')->orderby('id','desc')->first());
        return {Model}::query()->with('tempfile')
            ->orderby('id', 'desc');
    }
...
asass
    ...
    public function columncrad($label, $name, $type,$hidden)
    {
        ...
        if ($hidden ) {
            ...
            if($type==="LIST"){
              ...
              $datacol=$this->get_enum_values_query('{Module}',$name);
    ...
    */
    ...
    /**
     * PowerGrid {Model} Action Buttons.
     *
