         ...
         <div class="w-5/6 lg:w-2/4 xl:w-2/4 ">
           ...
           <form method="POST" action="{{url('users')}}/{{$rowuser->id}}">
               ...
               <div>
                   ...
                   <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="$rowuser->name" required />
               ...
               <div class="mt-4">
                   ...
                   <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="$rowuser->email" required />
